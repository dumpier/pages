    ...
    <div class="column">
        <table class="table border">
            ...
            <tbody>
                ...
                <tr><th rowspan="2"></th><td>売上</td><td class="amount income" id="monthly-1-1"></td><td class="right" id="yearly-1-1"><input type="text" class="amount income" id="input-yearly-1-1" value="600"></td></tr>
                ...
                <tr><th rowspan="2"></th><td>経費</td><td class="amount cost" id="monthly-2-1"></td><td class="right" id="yearly-2-1"><input type="text" class="amount cost" id="input-yearly-2-1" value="200"></td></tr>
                <tr><td>経費（補正用）</td><td class="amount cost" id="monthly-2-2"></td><td class="right" id="yearly-2-2"><input type="text" class="amount cost" id="input-yearly-2-2" value=""></td></tr>
                ...
                <tr><th rowspan="11"></th><td>基礎控除</td><td class="amount cost" id="monthly-3-1"></td><td class="right" id="yearly-3-1"><input type="text" class="amount cost" id="input-yearly-3-1" value="48"></td></tr>
                <tr><td>青色申告控除</td><td class="amount cost" id="monthly-3-2"></td><td class="right" id="yearly-3-2"><input type="text" class="amount cost" id="input-yearly-3-2" value="65"></td></tr>
                <tr><td>社会保険料控除</td><td class="amount cost" id="monthly-3-3"></td><td class="right" id="yearly-3-3"><input type="text" class="amount cost" id="input-yearly-3-3" value=""></td></tr>
                <tr><td>小規模企業共済等掛金控除</td><td class="amount cost" id="monthly-3-4"></td><td class="right" id="yearly-3-4"><input type="text" class="amount cost" id="input-yearly-3-4" value=""></td></tr>
                <tr><td>生命保険料控除</td><td class="amount cost" id="monthly-3-5"></td><td class="right" id="yearly-3-5"><input type="text" class="amount cost" id="input-yearly-3-5" value=""></td></tr>
                <tr><td>地震保険料控除</td><td class="amount cost" id="monthly-3-6"></td><td class="right" id="yearly-3-6"><input type="text" class="amount cost" id="input-yearly-3-6" value=""></td></tr>
                <tr><td>配偶者控除・配偶者特別控除</td><td class="amount cost" id="monthly-3-7"></td><td class="right" id="yearly-3-7"><input type="text" class="amount cost" id="input-yearly-3-7" value=""></td></tr>
                <tr>
                    ...
                    <td class="amount cost" id="monthly-3-8"></td><td class="amount" id="yearly-3-8"><input type="text" class="amount cost" id="input-yearly-3-8" value=""></td></tr>
                ...
                <tr><td>住宅ローン控除</td><td class="amount cost" id="monthly-3-10"></td><td class="amount" id="yearly-3-10"><input type="text" class="amount cost" id="input-yearly-3-10" value=""></td></tr>
                <tr><td>控除（補正用）</td><td class="amount cost" id="monthly-3-11"></td><td class="amount" id="yearly-3-11"><input type="text" class="amount cost" id="input-yearly-3-11" value=""></td></tr>
    ...
    <div class="column">
        <table class="table border">
            ...
            <tbody>
                ...
                <tr><td>住民税・所得割</td><td class="amount monthly" id="monthly-7-2"></td><td class="amount yearly" id="yearly-7-2"></td></tr>
                <tr><td>個人事業税</td><td class="amount monthly" id="monthly-7-3"></td><td class="amount yearly" id="yearly-7-3"></td></tr>
                <tr><td>所得税</td><td class="amount monthly" id="monthly-7-4"></td><td class="amount yearly" id="yearly-7-4"></td></tr>
                <tr><td>消費税</td><td class="amount monthly" id="monthly-7-5"></td><td class="amount yearly" id="yearly-7-5"></td></tr>
                <tr><td>固定資産税</td><td class="amount monthly" id="monthly-7-6"></td><td class="amount" id="yearly-7-6"><input type="text" class="amount" id="input-yearly-7-6" value=""></td></tr>
                ...
                <tr><td>保険（補正用）</td><td class="amount monthly" id="monthly-9-6"></td><td class="amount yearly" id="yearly-9-6"><input type="text" class="amount" id="input-yearly-9-6" value=""></td></tr>
