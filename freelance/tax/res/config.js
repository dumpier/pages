...
<div class="flex">
    <div class="column">
        <table class="table border">
            ...
            <tbody>
                <tr><th colspan="2">収入</th><td class="amount monthly th" id="monthly-income-0"></td><td class="amount yearly th bold" id="yearly-income-0"></td></tr>
                ...
                <tr><th colspan="2">経費</th><td class="amount monthly cost th" id="monthly-cost-0"></td><td class="amount yearly cost th bold" id="yearly-cost-0"></td></tr>
                ...
                <tr><th colspan="2">控除</th><td class="amount monthly cost th" id="monthly-deduction-0"></td><td class="amount yearly cost th bold" id="yearly-deduction-0"></td></tr>
                <tr><th rowspan="11"></th>
                ...
                <tr><th colspan="2"><span style="color:blue;">課税所得額</span></th><td class="amount monthly th" id="monthly-taxable-0"></td><td class="amount yearly th bold" id="yearly-taxable-0"></td></tr>
                <tr><th rowspan="2"></th>
    ...
    <div class="column">
        <table class="table border">
            ...
            <tbody>
                <tr><th colspan="4">税金</th><td class="amount monthly th"></td><td class="amount yearly th bold" id="yearly-tax-0"></td></tr>
                ...
                <tr><th colspan="4">年金</th><td class="amount monthly th"></td><td class="amount yearly th bold" id="yearly-pension-0"></td></tr>
                ...
                <tr><th colspan="4">保険</th><td class="amount monthly th" id="monthly-insurance-0"></td><td class="amount yearly th bold" id="yearly-insurance-0"></td></tr>
                ...
                <tr><th colspan="6">概要</th></tr>
                <tr><th rowspan="3"></th><td colspan="3">合計支払額（年金・保険・税金）</td><td class="amount monthly th" id="monthly-total-1"></td><td class="amount yearly th bold" id="yearly-total-1"></td></tr>
                <tr><td colspan="3">手取り額（経費含む）</td><td class="amount monthly th" id="monthly-total-2"></td><td class="amount yearly th bold" id="yearly-total-2"></td></tr>
            </tbody>
        </table>
    </div>
</div>
